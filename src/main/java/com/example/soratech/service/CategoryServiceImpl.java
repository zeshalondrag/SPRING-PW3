...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Page<Category> searchByName(String query, Pageable pageable) {
        return categoryRepository.findByNameContainingIgnoreCaseAndDeletedFalse(query, pageable);
    }

    @Override
    public List<Category> findAllActive() {
        return categoryRepository.findAllByDeletedFalse(Pageable.unpaged()).getContent();
    }
    ...
    @Override
    public Page<Category> searchDeletedByName(String query, Pageable pageable) {
        return categoryRepository.findByNameContainingIgnoreCaseAndDeletedTrue(query, pageable);
    }
}