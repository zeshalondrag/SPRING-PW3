...
public class SupplierController {
    ...
    public String listSuppliers(Model model,
        ...
        Page<Supplier> suppliersPage = query != null && !query.isEmpty()
                ? supplierService.searchByName(query, pageable)
                : supplierService.findAllActive(pageable);
    ...
    public String deletedSuppliers(Model model,
        ...
        Pageable pageable = PageRequest.of(page, size, sort);
        Page<Supplier> deletedPage = query != null && !query.isEmpty()
                ? supplierService.searchDeletedByName(query, pageable)
                : supplierService.findAllDeleted(pageable);
    ...
    public String restoreSupplier(@PathVariable Long id) {
        ...
        return "redirect:/suppliers/deleted";
    }
